---
name: linkedin-ops
description: Run a focused LinkedIn session for client acquisition. Handles inbox, high-value engagement, connection requests, content creation with Canva, profile optimization, account health, and scoring. Use when the user says "check LinkedIn", "run my LinkedIn session", "LinkedIn outreach", or "write today's LinkedIn post".
---
...
- Check `08-canva-template.md` for the current template
