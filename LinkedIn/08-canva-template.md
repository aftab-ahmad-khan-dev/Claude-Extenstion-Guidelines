---
name: linkedin-ops
description: Run a focused LinkedIn session for client acquisition. Handles inbox, high-value engagement, connection requests, content creation with Canva, profile optimization, and scoring. Use when the user says "check LinkedIn", "run my LinkedIn session", "LinkedIn outreach", or "write today's LinkedIn post".
---
...
2. High-value engagement (comments)
3. Personalized connection requests
4. Content creation (text + Canva visual when useful)
...
- Check `canva-template.md` for the current template
- Follow the design rules (1080×1350, 8–12 slides, clean & readable)
- Present both text and visual together for approval

## Profile
- Use `06-profile-optimization.md` when reviewing or updating the profile
- Keep the profile clear, outcome-focused, and natural

## Scoring
- Use the scoring system in `05-scoring-and-rules.md`
