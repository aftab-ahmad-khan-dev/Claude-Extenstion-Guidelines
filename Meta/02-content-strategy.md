...
### Visual & Format Ideas by Content Type
- Problem awareness: short vertical screen recording or Reel showing the real issue in action
- Why-it-fails: quick before/after carousel, image-led with minimal text
...
### Caption Structure
1. Strong scroll-stopping first line, states the problem sharper than the viewer would
2. Short and clear problem statement
3. Calm and precise solution insight, real value given away
4. Soft engagement question, never a CTA to buy or book
5. Relevant hashtags (mainly for Instagram, 3-8 relevant tags)
...
### Never Do
- Never caption with "DM me for pricing"
- Never lead with a personal announcement, always lead with the audience's problem
